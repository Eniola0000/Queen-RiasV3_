...
module.exports = {
    ...
    sudo: process.env.SUDO ? process.env.SUDO.split(",") : ["2348162226769"," 2347037781124"], // People Who can use the bot even in Private mode
    ...
    exifAuthor: process.env.EXIF_AUTHOR || "Eniola", // Author of the sticker pack
